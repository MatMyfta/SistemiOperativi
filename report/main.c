...
void unitnos_report_record_print(int *unitnos_report_records, int position, int total_char) {
	float percentage = 0;
	if (total_char != 0)
...
int main() {
	...
	while (input != 3) {
		switch(input) {
			case 0: unitnos_report_menu(); break;
			case 1: unitnos_report_full_print(unitnos_report_records,total_char); break;
			case 2: unitnos_report_partial_print(unitnos_report_records,total_char); break;
